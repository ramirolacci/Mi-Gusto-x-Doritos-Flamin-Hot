...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-black via-red-950 to-orange-950">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        <div className={`transition-all duration-1000 ${isLoaded ? 'fade-in-up' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-600/20 to-orange-600/20 rounded-full border border-orange-500/30 mb-8">
            ...
            <span className="text-orange-300 font-semibold text-sm uppercase tracking-wider">Colaboración Exclusiva</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="group px-8 py-4 bg-gradient-to-r from-red-600 to-orange-600 rounded-full text-white font-bold text-lg hover-lift fire-glow transition-all duration-300 hover:from-red-500 hover:to-orange-500">
              <span className="flex items-center gap-2">
                <Flame className="w-5 h-5 group-hover:animate-bounce" />
                Descubrir Ahora
              </span>
            </button>
            <button className="px-8 py-4 border-2 border-orange-500 text-orange-400 rounded-full font-semibold text-lg hover:bg-orange-500 hover:text-white transition-all duration-300 flame-border">
              Ver Lanzamiento
            </button>
          </div>
        </div>
      ...
      <div className="absolute right-10 top-1/2 transform -translate-y-1/2 hidden lg:block">
        <div className="floating">
          <div className="w-64 h-64 bg-gradient-to-br from-orange-500/20 to-red-600/20 rounded-full blur-3xl pulse-glow" />
        </div>
      </div>
